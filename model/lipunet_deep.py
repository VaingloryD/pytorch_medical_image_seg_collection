...
class lipUNet_deepsup(nn.Module):
    ...
    def __init__(self, in_channels=1, n_classes=3, feature_scale=2, is_deconv=True, is_batchnorm=True):
        ...
        # downsampling
        self.maxpool_1 = SimplifiedLIP(filters[0])
        self.maxpool_2 = SimplifiedLIP(filters[1])
        self.maxpool_3 = SimplifiedLIP(filters[2])
        self.maxpool_4 = SimplifiedLIP(filters[3])
...
if __name__ == '__main__':
    ...
    unet_plus_plus = lipUNet_deepsup(in_channels=1, n_classes=2).cuda()
