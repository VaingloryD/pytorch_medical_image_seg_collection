...
class Residual_UNet_deepsup(nn.Module):
    ...
    def __init__(self, in_channels=1, n_classes=4, feature_scale=2, is_deconv=True, is_batchnorm=True):
        ...
        self.conv1 = ResidualBlock(self.in_channels, filters[0], self.is_batchnorm)
        self.conv2 = ResidualBlock(filters[0], filters[1], self.is_batchnorm)
        self.conv3 = ResidualBlock(filters[1], filters[2], self.is_batchnorm)
        self.conv4 = ResidualBlock(filters[2], filters[3], self.is_batchnorm)
        self.center = ResidualBlock(filters[3], filters[4], self.is_batchnorm)
        # upsampling
...
if __name__ == '__main__':
    ...
    unet_plus_plus = Residual_UNet_deepsup(in_channels=1, n_classes=2).cuda()
