...
class  unet_deepsup_strip(nn.Module):
    def __init__(self, in_channels=1, n_classes=3, feature_scale=2, is_deconv=True, is_batchnorm=True):
        ...
        # downsampling
        self.maxpool_1 = StripPooling(filters[0],(128, 256),nn.BatchNorm2d)
        self.maxpool_2 = StripPooling(filters[1],(64, 128),nn.BatchNorm2d)
        self.maxpool_3 = StripPooling(filters[2],(32, 64),nn.BatchNorm2d)
        self.maxpool_4 = StripPooling(filters[3],(16, 32),nn.BatchNorm2d)
...
class StripPooling(nn.Module):
    ...
    def __init__(self, in_channels, pool_size, norm_layer):
        ...
        self.conv1_2 = nn.Sequential(nn.Conv2d(in_channels, inter_channels, 1, bias=False),
                                norm_layer(inter_channels),
                                nn.ReLU(True))
        self.conv2_0 = nn.Sequential(nn.Conv2d(inter_channels, inter_channels, 3, 2, 1, bias=False),
                                norm_layer(inter_channels))
    ...
    def forward(self, x):
        ...
        x2_2 = F.interpolate(self.conv2_1(self.pool1(x1)), (h//2, w//2), mode='bilinear')
        x2_3 = F.interpolate(self.conv2_2(self.pool2(x1)), (h//2, w//2), mode='bilinear')
...
if __name__ == '__main__':
    ...
    unet_plus_plus = unet_deepsup_stip(in_channels=1, n_classes=2).cuda()
